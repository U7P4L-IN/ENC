...
# Logo of U7P4L-IN
logo=f'''
{green}  _   _ _____ ____  _  _   _               ___ _   _ 
{yellow} | | | |___  |  _ \| || | | |             |_ _| \ | |
{red} | | | |  / /| |_) | || |_| |      _____   | ||  \| |
{blue} | |_| | / / |  __/|__   _| |___  |_____|  | || |\  |
{cyan}  \___/ /_/  |_|      |_| |_____|         |___|_| \_|
{purple}                                 [BY U7P4L IN]
...
def about():
    os.system("clear")
    sprint(logo, 0.01)
    print(f"{cyan}[ToolName]  {purple} :[Emoji-Enc]")
    print(f"{cyan}[Version]   {purple} :[1.0]")
    print(f"{cyan}[Author]    {purple} :[U7P4L]")
    print(f"{cyan}[Github]    {purple} :[https://github.com/U7P4L-IN]")
    print(f"{cyan}[Messenger] {purple} :[https://m.me/utpal.xr]")
    print(f"{cyan}[Email]     {purple} :[utpalxr@gmail.com]\n")
...
def encryptem():
    ...
    with open(in_file) as in_f, open(out_file, "w", encoding="utf-8") as out_f:
        out_f.write("# Encrypted by U7P4L-IN\n# Github- https://github.com/U7P4L-IN\n\n")
    ...
    while True:
        if choose == "1" or choose=="01":
            ...
            if os.path.exists("/data/data/com.termux/files/home"):
                os.system("xdg-open --view 'https://github.com/U7P4L-IN/U7P4L-IN#My-Best-Works'")
            else:
                os.system("xdg-open 'https://github.com/U7P4L-IN/U7P4L-IN#My-Best-Works'")
            main()
